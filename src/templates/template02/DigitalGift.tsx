...
export function DigitalGift({ guestName = "", guestSlug = "", invitation, invitationId }: {
  guestName?: string;
  guestSlug?: string;
  invitation: any;
  ...
  // Return null if no gift data - section won't be rendered
  if (!gift || !gift.methods || gift.methods.length === 0) {
    return null;
  }
