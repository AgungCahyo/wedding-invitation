...
export function Wishes({
  ...
  // Return null if no wishes data and no ability to submit (consistent with other sections)
  // But we always show the form, so we don't return null based on wishes data alone
  // Instead, we return null only if the wishes feature is completely unavailable
  if (unavailable) {
    return (
