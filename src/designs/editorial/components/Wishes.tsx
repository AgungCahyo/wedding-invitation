  ...
  return (
    <section id="wishes" className="section bg-[var(--bg-secondary)]">
      <div className="section-inner max-w-2xl">
        <SectionHeader index="07" label="Ucapan" />
        ...
        {unavailable ? (
          <motion.p
            ...
            className="text-[var(--text-tertiary)] text-sm font-body mb-12 md:mb-16"
          >
          ...
          <div className="mb-10 md:mb-12">
            {pinnedWishes.length === 1 ? (
              <motion.div
                ...
                variants={fadeUpEditorial}
                transition={{ duration: 0.8, ease: editorialEasing }}
                className="relative border border-[var(--accent)]/30 bg-[var(--bg-primary)] px-6 py-6 md:px-8 md:py-7 max-w-lg"
              >
                <div className="flex items-center gap-1.5 mb-4 text-[var(--accent)]">
                  <Pin size={12} strokeWidth={2} />
                  <span
                    className="text-[0.625rem] font-medium uppercase tracking-[0.25em]"
                ...
                <div className="flex items-baseline justify-between gap-4">
                  ...
                  <time
                    dateTime={pinnedWishes[0].date}
                    className="shrink-0 text-[0.625rem] font-medium uppercase tracking-[0.2em]"
        ...
        {isFetching ? (
          <p className="text-[var(--text-tertiary)] text-sm font-body py-12">Memuat ucapan...</p>
        ) : wishes.length === 0 ? (
          <p className="text-[var(--text-tertiary)] text-sm font-body py-12">Belum ada ucapan.</p>
          ...
          <HorizontalScroller ariaLabel="Ucapan tamu">
            {regularWishes.map((wish) => (
              ...
              >
                ...
                <div className="flex items-baseline justify-between gap-4">
                  <h4 className="font-body text-sm text-[var(--text-primary)] tracking-[0.02em]">{wish.name}</h4>
                  <time
                    dateTime={wish.date}
                    className="shrink-0 text-[0.625rem] font-medium uppercase tracking-[0.2em]"
                    style={{ fontFamily: "var(--font-label)", color: "var(--text-tertiary)" }}
