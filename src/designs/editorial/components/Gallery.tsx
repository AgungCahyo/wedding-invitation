  ...
  return (
    <section id="gallery" className="section bg-[var(--bg-secondary)]">
      <div className="section-inner">
        <SectionHeader index="04" label="Galeri" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-4 md:gap-6 auto-rows-min">
          {gallery.map((photo, index) => (
            <motion.button
              ...
              transition={{ delay: index * 0.07, duration: 0.8, ease: editorialEasing }}
          ...
          {selectedIndex !== null && (
            ...
            >
              ...
              >
                ...
                <p
                  className="text-center text-[var(--background)]/50 mt-6 text-[0.625rem] font-medium uppercase tracking-[0.25em]"
